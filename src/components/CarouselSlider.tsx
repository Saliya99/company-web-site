...
// Image imports
import office2 from '../images/w1.webp'
import office from '../images/w2.webp'
import conference from '../images/w3.webp'
import gwp from '../images/w4.webp'
import mao from '../images/w5.webp'
import meeting from '../images/w6.webp'
import wfh from '../images/w7.webp'
import workspace from '../images/w8.webp'
    ...
    <section className="bg-white py-8 dark:bg-gray-900 lg:py-16">
      ...
      <div className="relative mx-auto max-w-screen-xl px-16 sm:px-24">
        ...
        <button
          ...
          className="group absolute left-0 top-1/2 -translate-y-1/2 z-30 flex h-10 w-10 items-center justify-center rounded-full bg-gray-800/30 hover:bg-gray-800/60 focus:outline-none"
        >
          <svg
        ...
        <button
          onClick={goToNext}
          className="group absolute right-0 top-1/2 -translate-y-1/2 z-30 flex h-10 w-10 items-center justify-center rounded-full bg-gray-800/30 hover:bg-gray-800/60 focus:outline-none"
        >
          <svg
            className="h-6 w-6 text-white"
            fill="none"
