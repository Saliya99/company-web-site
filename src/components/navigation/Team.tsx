...
import img13 from '@/assets/images/jayawardana.webp'
import img14 from '@/assets/images/img-14.webp'
import img15 from '@/assets/images/img-15.webp'
import img16 from '@/assets/images/0C8A5504.webp'
        ...
        <div className="flex flex-col gap-8 sm:gap-12 xl:flex-row xl:items-start xl:gap-16">
          ...
          <div className="grid w-full shrink-0 grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 xl:max-w-3xl">
            ...
            <div className="group relative overflow-hidden rounded-lg">
              <Image
                className="h-[300px] w-full object-cover transition-all duration-300 ease-in group-hover:scale-110 lg:h-[400px]"
                src={img12}
                alt="Robert Brown"
                width={500}
                height={400}
