      ...
      <div className="mx-auto max-w-screen-xl px-4 py-8 lg:px-6 lg:py-16">
        <div className="mx-auto mb-8 max-w-screen-md text-center lg:mb-12">
          ...
          <p className="mb-5 font-light text-gray-500 dark:text-gray-400 sm:text-xl">
            Here at Smart Retailer we focus on markets where technology, innovation,
        ...
        <div className="space-y-8 sm:gap-6 lg:grid lg:grid-cols-3 lg:space-y-0 xl:gap-10">
          <div className="mx-auto flex max-w-lg flex-col rounded-lg border border-gray-100 bg-white p-6 text-center text-gray-900 shadow dark:border-gray-600 dark:bg-gray-800 dark:text-white xl:p-8">
            ...
            Best for small retail businesses & startups.
            </p>
            ...
            <ul role="list" className="mb-8 space-y-4 text-left">
              <li className="flex items-center space-x-3">
                ...
                <span>Access to Dashboard & Basic Reports</span>
              </li>
              <li className="flex items-center space-x-3">
                <svg
                  className="h-5 w-5 flex-shrink-0 text-green-500 dark:text-green-400"
                ...
                <span> Manage up to 100 Customers</span>
              </li>
              <li className="flex items-center space-x-3">
                <svg
                  className="h-5 w-5 flex-shrink-0 text-green-500 dark:text-green-400"
              ...
              <li className="flex items-center space-x-3">
                ...
                >
                  ...
                  <span >Generate Sales Invoices & Receipts</span>
          ...
          <div className="mx-auto flex max-w-lg flex-col rounded-lg border border-gray-100 bg-white p-6 text-center text-gray-900 shadow dark:border-gray-600 dark:bg-gray-800 dark:text-white xl:p-8">
            ...
            <p className="font-light text-gray-500 dark:text-gray-400 sm:text-lg">
            Ideal for growing businesses with expanding needs.
            </p>
            <div className="my-8 flex items-baseline justify-center">
            ...
            <ul role="list" className="mb-8 space-y-4 text-left">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span>Manage up to 1,000 Customers</span>
              </li>
              <li className="flex items-center space-x-3">
                <svg
                  className="h-5 w-5 flex-shrink-0 text-green-500 dark:text-green-400"
              ...
              <li className="flex items-center space-x-3">
                ...
                <span>
                Advanced Supplier & Purchasing System
                </span>
              </li>
              <li className="flex items-center space-x-3">
                <svg
                ...
                <span>
                Generate Detailed Reports (Sales, Inventory, Customers)
                </span>
              </li>
              <li className="flex items-center space-x-3">
                <svg
          ...
          <div className="mx-auto flex max-w-lg flex-col rounded-lg border border-gray-100 bg-white p-6 text-center text-gray-900 shadow dark:border-gray-600 dark:bg-gray-800 dark:text-white xl:p-8">
            ...
            <p className="font-light text-gray-500 dark:text-gray-400 sm:text-lg">
            Perfect for large-scale retail chains & enterprises.
            </p>
            <div className="my-8 flex items-baseline justify-center">
            ...
            <ul role="list" className="mb-8 space-y-4 text-left">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span>
                Role-Based User Management (Admin, Manager, Cashier, etc.)
                </span>
              </li>
              <li className="flex items-center space-x-3">
                <svg
